...
local button_widget = wibox.widget {
	{
		id = 'icon',
		image = widget_icon_dir .. 'moon-regular.svg',
...
local update_widget = function()
	if blue_light_state then
		...
		button_widget.icon:set_image(widget_icon_dir .. 'moon-solid.svg')
	else
		action_status:set_text('Off')
		widget_button.bg = beautiful.groups_bg
		button_widget.icon:set_image(widget_icon_dir .. 'moon-regular.svg')
	end
end
